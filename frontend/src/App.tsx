...
function Isolated_Layout() {
	...
	const onPolicy =															 // if user is on privacy-policy or terms-&-conditions page
		path === publicRoutes.policy ||
		path === publicRoutes.conditions;
...
export default function App() {
	...
	return (
		<>
			...
			<Routes>
				{/* Landing */}
				<Route path={publicRoutes.landing} element={<Navigate to={publicRoutes.login} replace />} />
